import { 
  FileText, Wrench, Brain, Cpu, Database, Globe, Bot, Monitor,
  Cloud, ClipboardList, Search, TrendingUp, Calendar, Clipboard,
  MessageCircle, RefreshCw, Target, FolderOpen
} from 'lucide-react';
...
export const portfolioData = {
  ...
  skills: {
    ...
    competencies: [
      { icon: <Search size={20} />, description: 'Análisis y diagnóstico en entornos críticos' },
  ...
  education: {
    certifications: [
      { id: "1", title: "Técnico Especialista en Informática de Gestión", institution: "CIF CARLOS III, Cartagena", year: "1998-2001", type: "certification" },
      { id: "2", title: "Curso de Ciberseguridad", institution: "INCIBE, León", year: "2018", type: "certification" },
      { id: "3", title: "Curso NATO HPS CRYPTO", institution: "Ministerio de Defensa", year: "2024", type: "certification" }
    ] as Education[],
    honors: [
      { id: "1", title: "Cruz del Mérito Aeronáutico", institution: "Distintivo Blanco", year: "", type: "honor" },
      { id: "2", title: "Cruz a la Constancia en el Servicio", institution: "Categoría Bronce", year: "", type: "honor" },
      { id: "3", title: "Reconocimiento Especial DANA 2024", institution: "Operaciones de emergencia y apoyo", year: "2024", type: "honor" }
    ] as Education[]
  },
  ...
  social: {
    ...
    whatsapp: "https://wa.me/34635956779?text=Hola%20Pedro,%20me%20interesa%20contactar%20contigo"
  }
};
