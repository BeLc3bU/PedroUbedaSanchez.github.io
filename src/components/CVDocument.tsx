    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.statsContainer}>
        <View style={styles.statBox}>
          ...
          <Text style={styles.statValue}>{portfolioData.stats[0].value}</Text>
          <Text style={styles.statLabel}>{portfolioData.stats[0].label}</Text>
        </View>
        <View style={styles.statBox}>
          <Text style={styles.statIcon}>🎖️</Text>
          <Text style={styles.statValue}>{portfolioData.stats[1].value}</Text>
          <Text style={styles.statLabel}>{portfolioData.stats[1].label}</Text>
        </View>
        <View style={styles.statBox}>
          <Text style={styles.statIcon}>⚙️</Text>
          <Text style={styles.statValue}>{portfolioData.stats[2].value}</Text>
          <Text style={styles.statLabel}>{portfolioData.stats[2].label}</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        {portfolioData.experience.map((exp) => (
          <View key={exp.id} style={{ marginBottom: 8 }}>
            ...
            <Text style={styles.period}>{exp.period} - {exp.location}</Text>
      ...
      <View style={styles.section}>
        ...
        {portfolioData.education.certifications.map((cert) => (
          <View key={cert.id} style={styles.educationItem}>
            ...
            <Text style={styles.educationDetail}>{cert.institution} {cert.year && `- ${cert.year}`}</Text>
          </View>
        ))}
      </View>
      ...
      <View style={styles.section}>
        ...
        {portfolioData.education.honors.map((honor) => (
          <Text key={honor.id} style={styles.honorsItem}>★ {honor.title} {honor.institution && `- ${honor.institution}`}</Text>
        ))}
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.skillsContainer}>
          {portfolioData.skills.tools.map((skill, i) => (
            <Text key={i} style={styles.skill}>{skill.description}</Text>
          ))}
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.skillsContainer}>
          {portfolioData.skills.competencies.map((skill, i) => (
            <Text key={i} style={styles.competency}>{skill.description}</Text>
          ))}
        </View>
      </View>
      ...
      <View style={styles.grid3}>
        ...
        <View style={styles.gridColumn}>
          ...
          {portfolioData.hobbies.map((hobby, i) => (
            <Text key={i} style={styles.text}>• {hobby}</Text>
          ))}
        </View>
      </View>
